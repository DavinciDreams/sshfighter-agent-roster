...
import {
  specialMoveForAttack, specialMoveMotionCode,
} from '../../vendor/sshfighter/src/game/moves.js';
import {
  emptyInputs, type AttackKind, type Inputs, type MatchPhase,
...
export const POLICY_SOURCE_SHA256 = '4b8c931506c8a235f30911d7a11a9986f3df5e1906d261dc4f6c41ed408334ec';
...
export function computeRunnerImplementationHash(): string {
  ...
  for (const relative of CODEX_RUNNER_IMPLEMENTATION_FILES) {
    ...
    digest.update(readFileSync(resolve(repositoryRoot, relative))).update('\0');
  }
