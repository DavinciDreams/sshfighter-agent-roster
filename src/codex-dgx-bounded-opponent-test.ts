...
import {
  attackActive, specialMoveStats,
} from '../vendor/sshfighter/src/game/engine.js';
import {
  SPECIAL_ATTACK_KINDS, type SpecialAttack,
} from '../vendor/sshfighter/src/game/moves.js';
import type {
  Fighter, Inputs, Match,
} from '../vendor/sshfighter/src/game/types.js';
import {
  MatchCoordinator, type WorkerRef,
} from '../vendor/sshfighter/src/cluster/coordinator.js';
import type { P2W } from '../vendor/sshfighter/src/cluster/messages.js';
import {
