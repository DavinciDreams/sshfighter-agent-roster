...
import { emptyInputs, type Inputs } from '../vendor/sshfighter/src/game/types.js';
import { clearEdges } from '../vendor/sshfighter/src/cluster/messages.js';
import { mergeCoordinatorInput } from '../vendor/sshfighter/src/cluster/coordinator.js';
import {
...
assert.equal(RUNNER_SOURCE_BASE_COMMIT, '22839b24ec0d01777a9835c6272ccea0d92fcf31');
assert.equal(TARGET_DEPLOYMENT_PROFILE, 'sshfighter-3caedf-unclose-17');
assert.equal(TARGET_ENGINE_COMMIT, '3caedf3435c12996cf4d34fb5ac76c7cd7b75076');
...
console.log('PASS  exact vendor-3caedf 17-fighter roster passes; old 16, substitutions, and order changes fail closed');
...
console.log('PASS  sf-6 health alone never attests the vendor-3caedf 17-roster profile or permits Lounge/input');
