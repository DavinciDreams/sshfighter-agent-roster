...
assert.equal(legacyManifest.ownerRepositoryLayout, 'agent-roster-with-pinned-sshfighter-submodule');
assert.equal(legacyManifest.runnerSourceBaseCommit, '22839b24ec0d01777a9835c6272ccea0d92fcf31');
assert.equal(legacyManifest.targetDeploymentProfile, 'sshfighter-3caedf-unclose-17');
assert.equal(legacyManifest.vendorSshfighterCommit, '3caedf3435c12996cf4d34fb5ac76c7cd7b75076');
