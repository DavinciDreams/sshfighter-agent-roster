...
import { specialMoveForAttack, specialMoveMotionCode } from '../../vendor/sshfighter/src/game/moves.js';
import type { SpecialAttack } from '../../vendor/sshfighter/src/game/moves.js';
import { ATTACKS, JUMPKICK, THROW, specialMoveStats } from '../../vendor/sshfighter/src/game/engine.js';
import { emptyInputs, type AttackKind, type Inputs, type MatchPhase } from '../../vendor/sshfighter/src/game/types.js';
